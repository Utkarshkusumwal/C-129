...
function gotResults(error, results) {
    ...
    console.log(results);
    sketch_to_draw = results[0].label;
    document.getElementById("Your_Sketch").innerHTML = " Your Sketch : " + sketch;
    document.getElementById("sketch_drawn").innerHTML = " Sketch drawn : " + results[0].label;
